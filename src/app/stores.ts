...
const Default: Lexc.Language = {
    ...
    Pronunciations: <Lexc.Pronunciations>{
        General: '/// Use this section to write rules that convert\n'
               + '/// your romanization to phonetic notation.\n'
               + '/// See the Pronunciation Rules section of\n'
               + '/// the Help tab for more information.',
    },
    RulesEngine: 'transubstantiator',
